...
const mockForums: Forum[] = [
  ...
  { id: 2, name: "Tech Support", description: "Get help with technical issues" },
  { id: 3, name: "Feature Requests", description: "Suggest new features for the platform" },
  { id: 4, name: "Bug Reports", description: "Report bugs and issues you've encountered" },
  { id: 5, name: "Off-Topic", description: "Random conversations and off-topic discussions" },
]
